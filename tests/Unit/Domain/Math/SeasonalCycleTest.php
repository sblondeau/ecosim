...
final class SeasonalCycleTest extends TestCase
{
    ...
    {
        self::assertEqualsWithDelta(1.0, SeasonalCycle::at(172, 172.0), 1e-9);
    }

    public function testReachesMinusOneHalfAYearLater(): void
    {
        self::assertEqualsWithDelta(-1.0, SeasonalCycle::at(172 + 183, 172.0), 1e-2);
    }

    public function testIsSymmetricAroundThePeak(): void
    {
        $before = SeasonalCycle::at(172 - 40, 172.0);
        $after = SeasonalCycle::at(172 + 40, 172.0);
